...
// ... (Imports and Logic remains same as previous full code) ...
// ... KEEP ALL YOUR LOGIC (States, API Calls, Handlers) ...
    ...
    <div className="bg-light min-vh-100">
      ...
      <div className="container mt-4 pb-5">
        ...
        <div className="card border-0 shadow-sm rounded-3 mb-4 bg-white p-3 p-md-4">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            ...
            <div className="d-flex flex-wrap gap-2 w-100 w-md-auto">
              ...
              <button onClick={() => setShowModal(true)} className="btn btn-success btn-sm px-3 flex-grow-1 flex-md-grow-0">
        ...
        <div className="card border-0 shadow-sm rounded-3">
            ...
            <div className="card-body p-0">
                <div className="table-responsive"> {/* <--- CRITICAL FOR MOBILE */}
                            ...
                            {citizen.vehicles && citizen.vehicles.length > 0 ? (
                                citizen.vehicles.map((vehicle, index) => (
                                    <tr key={vehicle.id}>
                                        ...
                                        <td>
                                            {/* Wrap buttons to avoid huge width */}
                                            <div className="d-flex gap-1">
                                                ...
                                                <button className="btn btn-sm btn-light text-primary px-2 py-0" title="Edit"><i className="bi bi-pencil"></i></button>
                                                <button className="btn btn-sm btn-light text-danger px-2 py-0" title="Delete"><i className="bi bi-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))
