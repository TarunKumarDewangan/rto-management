...
export default function QuickEntry() {
    ...
    const [activeTab, setActiveTab] = useState('PUCC'); // 'PUCC' or 'INSURANCE'
        ...
        <div className="bg-light min-vh-100">
            ...
            <div className="container mt-5" style={{maxWidth: '600px'}}>
                ...
                <div className="card border-0 shadow-lg">
                    <div className={`card-header text-white py-3 ${activeTab === 'PUCC' ? 'bg-success' : 'bg-primary'}`}>
                        <h5 className="mb-0 fw-bold">
                            {activeTab === 'PUCC' ? '⚡ PUCC Quick Entry' : '🛡️ Insurance Quick Entry'}
                        </h5>
                    </div>
                    <div className="card-body p-4">
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* Customer Details */}
                            <h6 className={`fw-bold mb-3 ${activeTab === 'PUCC' ? 'text-success' : 'text-primary'}`}>Customer Details</h6>
                            ...
                            {/* Vehicle Details */}
                            <h6 className={`fw-bold mb-3 mt-4 ${activeTab === 'PUCC' ? 'text-success' : 'text-primary'}`}>Vehicle Details</h6>
                            <div className="row g-3 mb-3">
                            ...
                            <h6 className={`fw-bold mb-3 mt-4 ${activeTab === 'PUCC' ? 'text-success' : 'text-primary'}`}>
                                {activeTab === 'PUCC' ? 'PUCC Validity' : 'Insurance Details'}
                            </h6>
                            ...
                            <div className="d-grid">
                                <button type="submit" className={`btn fw-bold py-2 ${activeTab === 'PUCC' ? 'btn-success' : 'btn-primary'}`} disabled={loading}>
